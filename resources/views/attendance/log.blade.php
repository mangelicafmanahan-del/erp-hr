...
@section('content')
    <div class="mb-6">
        ...
        <p class="text-gray-500">Track daily attendance, time in/out, and work hours.</p>
    </div>
    ...
    <div class="bg-white border rounded-lg overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y">
                ...
                @empty
                    <tr><td colspan="7" class="px-4 py-10 text-center text-gray-400">No active employees found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
